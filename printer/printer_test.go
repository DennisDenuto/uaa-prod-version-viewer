...
var _ = Describe("Printer", func() {
	...
	Describe("bitbar", func() {
		...
		It("should print a bitbar menu", func() {
			...
			Expect(writer).Should(Say(`---`))
			Expect(writer).Should(Say(`uaa-release: uaa-version \| color=white font=UbuntuMono-Bold size=12 href=https://github.com/cloudfoundry/uaa-release/tree/uaa-version`))
			...
			Expect(writer).Should(Say(`---`))
			Expect(writer).Should(Say(`uaa-release: uaa-version2 \| color=white font=UbuntuMono-Bold size=12 href=https://github.com/cloudfoundry/uaa-release/tree/uaa-version2`))
